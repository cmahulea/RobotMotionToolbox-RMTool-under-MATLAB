function Robots = drawBeliefMaps2(Robots,T,RegionColors)
...
%         end
        ...
        if isempty(Region2)
            ...
            Robots{i}.Beliefs{x}.filledRegion= fill(T.Vert{x}(1,:),T.Vert{x}(2,:),RegionColors(Region2,:));
        end
    end
