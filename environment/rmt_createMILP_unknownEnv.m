function MILP_data = rmt_createMILP_unknownEnv(Robots,PN,formula,i,planner)
%Construct the MILP
...
%CAMBIO
[~,~,~,Atask,btask]=rmt_formula2constraints(char(formula), [], [], PN.nlabels);
%Solo nos interesan los estados finales, los cuales se encuentran en la
% segunda mitad del array Atask
Atask = Atask(:,PN.nlabels + 1:2 * PN.nlabels);
if planner.Deterministic
