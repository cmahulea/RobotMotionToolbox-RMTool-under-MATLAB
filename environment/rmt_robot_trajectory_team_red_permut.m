...
function [R_runs,R_paths,R_trajs,active_robots] = rmt_robot_trajectory_team_red_permut(T,Tg,Tg_init,run_Tg,path_Tg,varargin)
%for Tg which is reduced w.r.t. robot permutations (Tg_init is the big (non-reduced) one)
...
R_paths=(Tg_init.st(Tg_init.q0,:))';   %column vector
