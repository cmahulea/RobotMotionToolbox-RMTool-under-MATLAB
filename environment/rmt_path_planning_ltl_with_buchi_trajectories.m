...
function [message,Run_cells] = rmt_path_planning_ltl_with_buchi_trajectories(xmin,Pre,Post,Run_cells,m0_robot,message)

nplaces = size(Pre,1);
ntrans = size(Pre,2);
intermediate_markings = length(xmin)/(nplaces+ntrans);
