...
function [R_runs,R_paths,R_trajs,active_robots] = rmt_robot_trajectory_team(T,Tg,run_Tg,path_Tg,varargin)
...
R_runs={Tg.st(run_Tg{1},:)' , Tg.st(run_Tg{2},:)'}; %project run of Tg to individual and synchronized robot runs
R_paths=Tg.st(path_Tg,:)';
